...
get_header(); // This fxn gets the header.php file and renders it ?>
	...
	<nav id="subnav" role="navigation" class="solar-benefits">
		<div class="container">
			<ul>
				<li><a href="/why-solar">Enjoy Electricity Again</a></li>
				<li><a href="/about-baker">Rates are Rising</a></li>
				<li><a href="/residential">Save with Baker</a></li>
				<li><a href="/commercial">Government Incentives</a></li>
				<li><a href="/contact-us">Environmental Impact</a></li>
			</ul>
		</div>
	</nav>
...
<div id="content" class="solar-benefits"><!-- start the page content -->

	<section id="block-01">
		<div class="container">
			<div class="col small-full medium-col-2 large-col-2">
				<div class="85 white-bg text-block">
					<h2>Try to say &ldquo;sunshine&rdquo; and &ldquo;savings&rdquo; without smiling. We dare you.</h2>
				</div>
				<div class="bottom cta">
					Get a free quote <span>&raquo;</span>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="col small-full medium-col-3 large-col-3">
				<div class="text-block">
					<h2>Get turned on by electricity again.</h2>
					<p>Stop counting kilowatts and start living stress-free with easy financing options, expert guidance, and unmatched service from Baker Electric Solar.</p>
				</div>
				<div class="button cta">
					Enjoy electricity again <span>&raquo;</span>
				</div>
			</div>
	...
	<section id="block-03">
		<div class="container">
			<div class="col small-full medium-col-3 large-col-3">
				<div class="text-block">
					<h2>Unplug from your electric company.</h2>
					<p>The clean energy produced by the sun is yours to harness for powering your home or business. By choosing solar, you become the provider of your electrical energy needs.</p>
				</div>
				<div class="button cta">
					Rates are rising <span>&raquo;</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="block-04" class="unexpanded">
		<div class="container">
			...
			<div class="col small-full medium-col-3 large-col-3">
				<div class="text-block">
					<h2>Turn up the savings.</h2>
					<p>With low monthly payments and little or no money down, switching to Baker Electric Solar could eliminate your electric bills and your monthly bill anxiety.</p>
				</div>
				<div class="button cta">
					Save with Baker <span>&raquo;</span>
				</div>
			</div>
			...
			<img src="/wp-content/themes/baker/images/scroll-to-top.png" class="scroll-to-top" />
	...
	<section id="block-05">
		<div class="container">
			<div class="col small-full medium-col-3 large-col-3">
				<div class="text-block">
					<h2>Rebates, tax credits and incentives, oh my.</h2>
					<p>Between California Solar Initiative rebates and the Investment Tax Credit (ITC), there’s no more a cost-efficient time to invest in solar than now.</p>
				</div>
				<div class="button cta">
					Government incentives <span>&raquo;</span>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="block-06">
		<div class="container">
			<div class="col small-full medium-col-3 large-col-3">
				<div class="text-block">
					<h2>Soak up the sun, not fossil fuels.</h2>
					<p>Taking the plunge to solar for powering your home or business will not only reduce your electric bill, but your carbon footprint as well.</p>
				</div>
				<div class="button cta">
					Environmental impact <span>&raquo;</span>
				</div>
			</div>
			<div class="circle transparent">
				<img src="/wp-content/themes/baker/images/circle-transparent-mask.png" />
...
$(document).ready(function() {
	...
	$( "#block-04.unexpanded .cta" ).on("click", function() {
		$("#block-04 .accordion").slideDown("slow", function() {
			$("#block-04 .close-button").fadeIn("fast");
			$("#block-04 .scroll-to-top").fadeIn("fast");
			$("#block-04").removeClass("unexpanded");			
		});

	});

	$( "#block-04 .close-button" ).on("click", function() {
		$("#block-04 .accordion").slideUp("slow");
		$("#block-04 .close-button").fadeOut("fast");
		$("#block-04 .scroll-to-top").fadeOut("fast");
		$("#block-04").addClass("unexpanded");
	});

	$("#block-04 .scroll-to-top").on("click", function() {
		$("body").scrollTo( $("#block-04"), 800,  {offset:-210} );
	});
